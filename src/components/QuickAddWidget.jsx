            ...
            <div className="relative z-10">
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1 custom-scrollbar">
                    {COMMON_INTERVENTIONS.map((item) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                <span className="text-4xl mb-3 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 drop-shadow-lg">
                                    {item.icon}
                                </span>

                                <span className="text-xs font-bold text-slate-300 text-center px-2 leading-tight group-hover:text-white transition-colors">
                                    {loading === item.name ? (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            <div className="w-12 h-12 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-center mb-2 group-hover:border-primary/60 group-hover:bg-primary/20 transition-all duration-300 group-hover:rotate-90">
