        ...
        <div className="hidden lg:flex items-center gap-8 text-sm">
            {user ? (
                <>
                    ...
                    <div className="relative group">
                        <button
                            className={`flex items-center gap-1.5 font-medium transition-colors ${isActiveGroup(["/workout", "/workouts"]) ? "text-primary" : "text-slate-300 hover:text-slate-50"
                                }`}
                        >
                            Workouts
                            <svg className="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="relative group">
                        <button
                            className={`flex items-center gap-1.5 font-medium transition-colors ${isActiveGroup(["/nutrition", "/food-analysis"]) ? "text-primary" : "text-slate-300 hover:text-slate-50"
                                }`}
                        >
                            Nutrition
                            <svg className="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
