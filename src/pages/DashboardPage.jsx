    ...
    >
      ...
      <section className="px-5 pt-6 pb-4 relative">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="relative float">
            ...
            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-emerald-500 
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          {/* Age Card */}
          <div className="glass-card rounded-3xl p-5 group hover:border-primary/50 hover:bg-white/10
            ...
            <p className="text-xs text-slate-400 font-semibold mb-1 uppercase tracking-wide">Age</p>
          ...
          {/* Weight Card */}
          <div className="glass-card rounded-3xl p-5 group hover:border-emerald-500/50 hover:bg-white/10
                        transition-all duration-300 hover:scale-[1.02] hover:shadow-glow shimmer">
            <div className="flex items-start justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-500/10 
                            flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <p className="text-xs text-slate-400 font-semibold mb-1 uppercase tracking-wide">Weight</p>
            <p className="text-3xl font-black text-slate-50">
              {profile.weightKg || "--"}
              {profile.weightKg && (
          ...
          <div className="glass-card rounded-3xl p-5 group hover:border-purple-500/50 hover:bg-white/10
            ...
            <p className="text-xs text-slate-400 font-semibold mb-1 uppercase tracking-wide">BMI</p>
          ...
          <div className="glass-card rounded-3xl p-5 group hover:border-amber-500/50 hover:bg-white/10
            ...
            <p className="text-xs text-slate-400 font-semibold mb-1 uppercase tracking-wide">Height</p>
            <p className="text-3xl font-black text-slate-50">
              {profile.heightCm || "--"}
              {profile.heightCm && (
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-3 px-1">
            <div>
              <h3 className="text-xl font-black text-slate-50">Weekly Health Trends</h3>
              <p className="text-xs text-slate-500 mt-0.5">Track your daily wellness metrics</p>
            </div>
            <button
              onClick={() => setIsCheckInOpen(true)}
              className="relative text-sm font-bold text-slate-950 transition-all duration-300 
                       bg-gradient-to-r from-primary to-emerald-500 px-4 py-2 rounded-xl 
                       hover:shadow-premium hover:scale-105 active:scale-95 shimmer overflow-hidden
                       group"
            >
        ...
        {/* Goal Banner */}
        {profile.goal && (
          <div className="relative glass-card rounded-2xl p-5 mb-6 overflow-hidden group
            ...
            <div className="relative flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-emerald-500/20 
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-slate-200 leading-relaxed font-medium">{profile.goal}</p>
              </div>
            </div>
          </div>
        )}
      ...
      <section className="px-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-2xl font-black text-slate-50">Profile Details</h2>
            <p className="text-xs text-slate-500 mt-0.5">Manage your personal information</p>
          </div>
          <button
            onClick={() => setEditMode(!editMode)}
            className={`px-5 py-2.5 rounded-xl font-bold text-sm transition-all duration-300
                     active:scale-95 hover:scale-105 ${editMode
                ? 'glass-card hover:border-slate-600'
                : 'bg-gradient-to-r from-primary to-emerald-500 text-slate-950 shadow-premium hover:shadow-glow shimmer'
              }`}
          >
        ...
        {editMode ? (
          ...
          <div className="space-y-3">
            ...
            <div className="glass-card rounded-2xl p-5 hover:border-primary/30 transition-all duration-300">
              <h3 className="text-sm font-bold text-primary mb-4 uppercase tracking-wide">Personal Information</h3>
              <div className="space-y-3">
      ...
      {!editMode && (
        <button
          ...
          className="fixed bottom-20 right-5 w-14 h-14 rounded-full bg-gradient-to-r from-primary to-emerald-500 
                   text-slate-950 shadow-2xl flex items-center justify-center
                   hover:scale-110 active:scale-95 transition-all duration-300 z-40 pulse-glow
