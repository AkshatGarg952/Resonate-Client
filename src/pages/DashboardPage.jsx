        ...
        {editMode ? (
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800/50 rounded-3xl p-6">
            <form onSubmit={handleSave} className="space-y-4">
                ...
                <label className="flex items-center justify-between cursor-pointer group">
                  <div className="flex items-center gap-3">
                    <div className={`w-11 h-6 rounded-full transition-all duration-300 ${
                      profile.hasMedicalCondition ? 'bg-primary' : 'bg-slate-700'
                    }`}>
                      <div className={`w-5 h-5 bg-white rounded-full mt-0.5 transition-all duration-300 ${
                        profile.hasMedicalCondition ? 'ml-5' : 'ml-0.5'
                      }`}></div>
                    </div>
              ...
              {message && (
                <div className={`flex items-start gap-3 text-sm rounded-2xl px-4 py-3 border ${
