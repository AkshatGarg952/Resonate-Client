  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 overflow-x-hidden">
      ...
      >
        ...
        <p
          className={`text-base sm:text-lg text-slate-400 text-center mb-10 max-w-md px-2 leading-relaxed transition-all duration-700 delay-300 ${isVisible ? 'opacity-100' : 'opacity-0'
            }`}
        >
